...
void Agency::PrintAllData(fstream & output)
{
	output << this->m_name << ' '
		<< this->m_zipcode << endl;
...
fstream & FirstMenuOption(char *, int &, fstream &);
void SecondMenuOption();
void ThirdMenuOption();
void FourthMenuOption();
...
fstream & FirstMenuOption(char * tempagencyname, int & tempagencyzipcode, fstream & inputfile)
{
